...
`{{Owner}} — {{Agent}}, {{Brokerage}} in {{City}}. Rents on your block just jumped ~{{Pct}}% on two new deals. That's a value-add lever for your NOI. If your leases are rolling, that's real money. Want the comps? No strings.`},
...
YOU: The good news is, buyers are often quite flexible on occupancy. This gives us a comfortable window to prepare your home without feeling rushed. It also means we can line things up so you transition smoothly from one home to the next. Does that timeline make sense to you?`},
 ...
 {t:"senior",ch:"call",adv:"Bruce Nemovitz",title:"Four Kids, Four Opinions",body:`YOU: Hello {{Owner}}, this is {{Agent}} with {{Brokerage}}. I understand you have four kids each with their own view on the family home. That's a lot to sort through.
YOU: First, let's anchor the timeline around any move‑in date you already have for a new place. Listing about 2-3 months before that gives us a comfortable window for everyone.
YOU: I'll pull a recent market report for {{Address}} - it shows what similar homes in {{City}} are selling for as‑is. That number lets the family see a neutral, fact‑based picture.
YOU: From there we can decide if the as‑is price meets your goals, or if a few small fixes might raise the value enough to make a difference.
YOU: Whatever you choose, we'll handle the paperwork, the clean‑out, and coordinate any specialists so the process stays low‑stress.
YOU: There is no perfect time, but if you're asking the question, the time is near.`},
...
YOU: My job is to give you the tools to make informed decisions. It's not about being morbid, it's about being useful. We can just talk through what a 30-day market-ready checklist looks like, for example, just so you have it. Does that sound like a good next step?`},
 ...
 {t:"adultchild",ch:"call",adv:"Chris Spade",title:"Sell Now or Wait for the Step-Up",body:`YOU: Hi, this is {{Agent}} with {{Brokerage}}. I understand you've got a call about whether to sell now or wait for the step‑up. Do you have a few minutes to walk through the numbers first? (pause) 
YOU: Great. The step‑up can wipe out capital gains for your sibling's share, but it only kicks in at the date of death. If you sell now, we can lock in today's market price and use the proceeds to cover any care costs, reverse‑mortgage payoff, or a new place for Mom. 
YOU: On the other hand, waiting could mean a higher basis and less tax, but it also means the house stays on the market longer and you keep managing upkeep. 
YOU: Let me send you a quick 30‑day market‑ready checklist - it turns the house into a list of concrete tasks, so you can see exactly what's involved either way. 
YOU: After you've reviewed that, we can talk about timing, listing strategy, and how the money flows. How does that sound?`},
...
YOU: Great. So, if we could sell your home quickly and for the right price, what would that let you do next?`},
 ...
 {t:"senior",ch:"vm",adv:"Bruce Nemovitz",title:"As-Is Voicemail",body:`Hi {{Owner}}, this is {{Agent}} with {{Brokerage}}. I'm calling about your home at {{Address}}. You can list it as‑is—no repairs, no cleaning, no rush. I'll handle the paperwork, coordinate movers, and match the timing to any senior community move‑in you have. There's no pressure; if you're curious, give me a call back. There is no perfect time, but if you're asking the question, the time is near.`},
...
`YOU: {{Owner}}, this is {{Agent}} with {{Brokerage}}. I work exclusively with owners on the county's tax-default list, and what I've seen is the taxes are rarely the core problem. Usually, it's an income issue, a divorce, or too much debt stacking up. So, instead of lecturing you about deadlines, my first question is: do you have a sale date set for {{Address}}?
...
`YOU: Buenas tardes {{Owner}}, le habla {{Agent}} de {{Brokerage}}. (Pause) Sé que su tiempo es valioso, ¿me regala un minuto? Esto es importante.
